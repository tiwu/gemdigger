# Context
The user wants a browser-based mining game ("Digger" style) where they play as a drill searching for gems. Since no existing codebase exists, I am designing a standalone web application from scratch.
...
4. **Progression**: Drills could potentially "level up" or gain speed as more gems are found.
