...
**v0.3.0 (Current):** "The Drill Wear Update". Soft-locked progression, per-tile fuel costs, reinforced bits, emoji gems, procedural textures, WASD support, and contextual onboarding.
